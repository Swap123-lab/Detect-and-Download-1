...
class Memcached(abstractPlugin.pluginBlueprint):
    ...
    # to detect the name of latest released versions and return the list to update_json
        ...
        check_date_url = "https://memcached.org/downloads"
    ...
    def update_json(self):
        ...
        for i in range(len(new_releases)):
            ...
            with open(cur_path + "/data/memcached.json", 'r+') as file:
